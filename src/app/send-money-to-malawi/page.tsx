...
export const metadata: Metadata = {
  title: "Send Money To Kenya | Payvel - Fast, Secure, No Fees",
  description:
    "Experience seamless money transfers with Payvel. Fast, secure, and no hidden fees.",
  alternates: { canonical: "/send-money-to-malawi" },
};
  ...
  return (
    <>
      <SendMoneyHero
        ...
        toCountry="Malawi"
        toCurrency="MWK"
        heroImage="/img/send-money/malawi/image.webp"
      />
      <DirectLineHome />
      <HowItWorks />
      <BudgetHome />
