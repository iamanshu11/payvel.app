...
export const metadata: Metadata = {
  title: "Send Money To Zambia | Payvel - Fast, Secure, No Fees",
  description:
    "Experience seamless money transfers with Payvel. Fast, secure, and no hidden fees.",
  alternates: { canonical: "/send-money-to-zambia" },
};
  ...
  return (
    <>
      <SendMoneyHero
        ...
        toCountry="Zambia"
        toCurrency="ZMW"
        heroImage="/img/send-money/zambia/image.webp"
      />
      <DirectLineHome />
      <HowItWorks />
      <BudgetHome />
      <SendApp backgroundImage="/img/send-money/zambia/app.webp" />
      <AudNgnSlider />
      <FAQComponent country="Zambia"/>
    </>
  );
}