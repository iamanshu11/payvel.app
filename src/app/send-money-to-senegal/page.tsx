...
export const metadata: Metadata = {
  title: "Send Money To Senegal | Payvel - Fast, Secure, No Fees",
  description:
    "Experience seamless money transfers with Payvel. Fast, secure, and no hidden fees.",
  alternates: { canonical: "/send-money-to-senegal" },
};
  ...
  return (
    <>
      <SendMoneyHero
        ...
        toCountry="Senegal"
        toCurrency="XOF"
        heroImage="/img/send-money/senegal/image.webp"
      />
      <DirectLineHome />
      <HowItWorks />
      <BudgetHome />
      <SendApp backgroundImage="/img/send-money/senegal/app.webp" />
      <AudNgnSlider />
      <FAQComponent  country="Senegal"/>
    </>
  );
}
