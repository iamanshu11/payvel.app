...
export const metadata: Metadata = {
  title: "Send Money To Republic of Congo | Payvel - Fast, Secure, No Fees",
  description:
    "Experience seamless money transfers with Payvel. Fast, secure, and no hidden fees.",
  alternates: { canonical: "/send-money-to-republic-of-congo" },
};
  ...
  return (
    <>
      <SendMoneyHero
        ...
        toCountry="Republic of Congo"
        toCurrency="XAF"
        heroImage="/img/send-money/republic/image.webp"
      />
      <DirectLineHome />
      <HowItWorks />
      <BudgetHome />
      <SendApp backgroundImage="/img/send-money/republic/app.webp" />
      <AudNgnSlider />
      <FAQComponent  country="Republic of Congo"/>
    </>
  );
}
