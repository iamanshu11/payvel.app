...
export const metadata: Metadata = {
  title: "Send Money To Tanzania | Payvel - Fast, Secure, No Fees",
  description:
    "Experience seamless money transfers with Payvel. Fast, secure, and no hidden fees.",
  alternates: { canonical: "/send-money-to-tanzania" },
};
  ...
  return (
    <>
      <SendMoneyHero
        ...
        toCountry="Tanzania"
        toCurrency="TZS"
        heroImage="/img/send-money/tanzania/image.webp"
      />
      <DirectLineHome />
      <HowItWorks />
      <BudgetHome />
      <SendApp backgroundImage="/img/send-money/tanzania/app.webp" />
      <AudNgnSlider />
      <FAQComponent country="Tanzania" />
    </>
  );
}
