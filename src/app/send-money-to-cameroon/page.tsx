...
export const metadata: Metadata = {
  title: "Send Money To Cameroon | Payvel - Fast, Secure, No Fees",
  description:
    "Experience seamless money transfers with Payvel. Fast, secure, and no hidden fees.",
  alternates: { canonical: "/send-money-to-cameroon" },
};
...
export default function HomePage() {
  ...
  toCountry="Cameroon"  // ✅ Fixed spelling - added the missing 'a'
  toCurrency="XAF"
  heroImage="/img/send-money/cameroon/image.webp"
/>
<DirectLineHome />
      <HowItWorks />
      <BudgetHome />
      <SendApp backgroundImage="/img/send-money/cameroon/app.webp" />
      <AudNgnSlider />
      <FAQComponent country="Cameroon"/>
