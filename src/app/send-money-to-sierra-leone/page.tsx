...
export const metadata: Metadata = {
  title: "Send Money To Sierra Leone | Payvel - Fast, Secure, No Fees",
  description:
    "Experience seamless money transfers with Payvel. Fast, secure, and no hidden fees.",
  alternates: { canonical: "/send-money-to-sierra-leone" },
};
...
export default function HomePage() {
  return (
    <>
      ...
      toCountry="Sierra Leone"
      toCurrency="SLL"
      heroImage="/img/send-money/malawi/image.webp" // Your Benin hero image
    />
    <DirectLineHome />
      <HowItWorks /> 
      <BudgetHome />
      <SendApp backgroundImage="/img/send-money/malawi/app.webp" />
      <AudNgnSlider />
      <FAQComponent country="Sierra Leone"/>
