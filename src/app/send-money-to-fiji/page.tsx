...
export const metadata: Metadata = {
  title: "Send Money To Fiji | Payvel - Fast, Secure, No Fees",
  description:
    "Experience seamless money transfers with Payvel. Fast, secure, and no hidden fees.",
  alternates: { canonical: "/send-money-to-fiji" },
};
...
export default function HomePage() {
  return (
    <>
      ...
      toCountry="Fiji"
      toCurrency="FJD"
      heroImage="/img/send-money/burkina-faso/image.webp" // Your Benin hero image
    />
    <DirectLineHome />
      <HowItWorks /> 
      <BudgetHome />
      <SendApp backgroundImage="/img/send-money/fiji/app.webp" />
      <AudNgnSlider />
      <FAQComponent country="Fiji"/>
