...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/send-money-to-kenya" },
};
  ...
  return (
    <>
      <SendMoneyHero
        ...
        toCountry="Kenya"
        toCurrency="KES"
        heroImage="/img/send-money/kenya/image.webp"
      />
      <DirectLineHome />
      <HowItWorks />
      <BudgetHome />
      <SendApp backgroundImage="/img/send-money/kenya/app.webp" />
      <AudNgnSlider />
      <FAQComponent country="Kenya"/>
    </>
  );
}
