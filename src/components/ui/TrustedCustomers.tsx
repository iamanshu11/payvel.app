  ...
  return (
    <section className="relative min-h-screen flex items-center bg-white dark:bg-black py-20 px-4 overflow-hidden transition-colors duration-300">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          Trusted by{' '}
          <span className="text-blue-500 dark:text-blue-400">500,000+</span>
          <br />
          Customers Globally
        </h2>
        ...
        <button
          data-aos="fade-up"
          data-aos-delay="400"
          className="bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-full text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 inline-flex items-center gap-2"
        >
