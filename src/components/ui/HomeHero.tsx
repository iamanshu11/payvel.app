        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <p className="hero-subtitle mt-6 text-lg lg:text-xl text-gray-600 dark:text-gray-300 max-w-xl">
              Send money from Australia, US and Canada, to globally with love. Fast, secure, and low-cost transfers right from your phone. Because family is everything.
            </p>
            <div className="mt-8 flex flex-wrap gap-4 justify-center lg:justify-start">
              <a href="https://staging.payvelremit.com" className="px-8 py-4 bg-teal-500 text-white rounded-full font-semibold text-lg hover:bg-teal-600 transition-all shadow-lg hover:shadow-2xl hover:scale-105">
                Send Money
              </a>
            </div>
          </div>
