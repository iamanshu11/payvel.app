      ...
      component: (
        <div className="w-full h-full bg-cyan-50 dark:bg-gradient-to-br from-gray-950 via-gray-900 to-black dark:from-black dark:via-gray-950 dark:to-gray-900 p-4 overflow-auto">
          ...
          <div className="bg-gradient-to-br from-teal-400 to-cyan-500 rounded-2xl p-4 mb-4 shadow-lg">
            <div className="text-white text-xs font-semibold mb-3">
              TODAY RATE
            </div>
            ...
            <div className="dark:text-gray-900  text-white text-xs mt-3">
              Conversation Rate: 1.8
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            <div className="flex flex-col items-center gap-1">
              ...
              <p className="text-xs text-blue-600 dark:text-blue-100 text-center font-medium">
                Student Hub
              </p>
            </div>
            <div className="flex flex-col items-center gap-1">
          ...
          <div className="flex justify-center mt-3">
            <div className="flex flex-col items-center gap-1">
              ...
              <p className="text-xs text-blue-600 dark:text-blue-100 font-medium">
                Vouchers
              </p>
            </div>
          </div>
        ...
        <div className="w-full h-full bg-cyan-50 dark:bg-gradient-to-br from-gray-950 via-gray-900 to-black dark:from-black dark:via-gray-950 dark:to-gray-900 p-4 scrollbar-hide overflow-auto scrollbar-hide">
          ...
          <div className="mb-4">
            <label className="text-xs font-semibold mb-2 block">
              Your Origin country and currency
            </label>
            <div className="flex items-center gap-2 mb-2">
          ...
          <div className="mb-4">
            ...
            <button className="mt-2 bg-teal-500 text-white text-xs px-3 py-1.5 rounded-lg">
              Add new currency
            </button>
          </div>
        ...
        <div className="w-full h-full bg-cyan-50 dark:bg-gradient-to-br from-gray-950 via-gray-900 to-black dark:from-black dark:via-gray-950 dark:to-gray-900  p-4 overflow-hidden">
          ...
          <div className="bg-gradient-to-br from-teal-400 to-cyan-500 rounded-2xl p-4 shadow-sm mb-4">
            ...
            <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-teal-700 to-cyan-700"
                style={{ width: "60%" }}
              ></div>
            </div>
            ...
            <div className="transition-all duration-700 ease-in-out">
                ...
                <>
                  <h1 className="hero-title text-5xl lg:text-7xl font-extrabold tracking-tight leading-tight">
                    <span className="relative">
                      ...
                      Everything in One{" "}
                      <span className="text-teal-500">Place</span>
                    </span>
                  </h1>
                  <p className="hero-subtitle mt-6 text-lg lg:text-xl text-gray-600 dark:text-gray-300 max-w-xl">
                    Instantly check rates, access specialized hubs for students
                    or travel, and manage your profile. Payvel puts your entire
                    financial world at your fingertips.
                  </p>
              ...
              {currentSlide === 1 && (
                <>
                  ...
                  <p className="hero-subtitle mt-6 text-lg lg:text-xl text-gray-600 dark:text-gray-300 max-w-xl">
                    Never guess the best time to send. Set your ideal exchange
                    rate, and we'll monitor the markets 24/7, notifying you
                    instantly when it's the right time to transfer.
                  </p>
                  <div className="mt-8 flex flex-wrap gap-4 justify-center lg:justify-start">
                    {/* CTA moved to single centralized button below so it's consistent across slides */}
              ...
              {currentSlide === 2 && (
                <>
                  ...
                  <p className="hero-subtitle mt-6 text-lg lg:text-xl text-gray-600 dark:text-gray-300 max-w-xl">
                    From automatic spending categories to personalized budgets
                    and savings goals, Payvel gives you the tools to see where
                    your money goes and make it work for you.
                  </p>
                  <div className="mt-8 flex flex-wrap gap-4 justify-center lg:justify-start">
                    {/* CTA moved to single centralized button below so it's consistent across slides */}
                    {/* <a href="/how-it-works" className="px-8 py-4 bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white rounded-full font-semibold text-lg hover:bg-gray-300 dark:hover:bg-gray-700 transition-all shadow-lg hover:shadow-2xl hover:scale-105">
                ...
                <>
                  <h1 className="hero-title text-5xl lg:text-7xl font-extrabold tracking-tight leading-tight">
                    <span className="relative">
                      <span className="absolute inset-0 blur-2xl bg-gradient-to-r from-blue-500 to-purple-400 opacity-40 -z-10"></span>
                      Move with {" "}
                      <span className="text-blue-500">Payvel</span>
                    </span>
                  </h1>
                  <p className="hero-subtitle mt-6 text-lg lg:text-xl text-gray-600 dark:text-gray-300 max-w-xl">
                    Instantly book international flights and reserve hotels across the globe. Manage your complete itinerary and travel payments all in one place.
