...
const HowItWorks: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-white dark:bg-gray-900 transition-colors duration-500 min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-12 lg:px-16 relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 dark:text-white mb-4 leading-tight">
            How{" "}
            <span className="bg-gradient-to-r from-[#00B6DE] to-[#0066CC] bg-clip-text text-transparent animate-gradient">
              Payvel
            </span>{" "}
            Works
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300">
            Sending money across borders is easy, fast, and secure. Follow our
            simple 5-step process to connect with your loved ones instantly.
          </p>
        </div>
        ...
        <div className="relative flex flex-col items-center">
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div
                className={`hidden md:flex items-center justify-center w-16 h-16 bg-white dark:bg-gray-900 border-4 rounded-full z-20 transition-all duration-500 transform ${
                  hoveredStep === step.id
              ...
              >
                  ...
                  <step.Icon
                    className={`w-6 h-6 transition-all duration-500 transform ${
                      hoveredStep === step.id
                        ...
                        : `${step.color} dark:${step.color.replace(
                            "500",
                            "400"
                          )}`
                    }`}
                ...
                {hoveredStep === step.id && (
                  <>
                    <div
                      className={`absolute inset-0 rounded-full bg-gradient-to-br ${step.gradient} animate-ping opacity-75`}
                    ></div>
                    <div
                      className={`absolute inset-0 rounded-full bg-gradient-to-br ${step.gradient} animate-pulse`}
                    ></div>
                  </>
                )}
              </div>
              ...
              >
                ...
                <div
                  className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${step.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500 p-[2px]`}
                >
                ...
                <div className="relative z-10">
                  <span
                    className={`text-2xl font-extrabold mb-2 inline-block bg-gradient-to-r ${
                      step.gradient
                  ...
                  <h3
                    className={`text-2xl font-bold text-gray-900 dark:text-white mb-3 transition-all duration-300 ${
                      hoveredStep === step.id
                ...
                <div
                  ...
                  } bottom-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:translate-x-1`}
                >
      ...
      {/* Final CTA - Animated */}
      <div
        className={`mt-20 text-center px-6 transition-all duration-1000 delay-1000 ${
