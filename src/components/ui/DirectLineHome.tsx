...
export default function DirectLineHome() {
  ...
  const handleCountryClick = (country: { name: string; code: string; url?: string }) => {
    if (country.url) {
